exports.generateBookingRestemplate = (code) => {
  return `<!DOCTYPE html>
    ...
    <head>
        ...
        <style>
            ...
            .container {
                width: 100%;
                background-image: url('https://64.media.tumblr.com/995aac6240336c4245956e5ae86705f8/tumblr_inline_pb0n8peFPH1r02mf8_1280.jpg');
    ...
    <body>
        <div class="container">
            <div class="glass-effect">
                <h1 style="text-align: center; color: #000; font-size: 32px;">StayHub</h1>
                <p style="color: #000; font-size: 22px; margin-bottom: 20px;">"Travel is the only thing you buy that makes you richer."</p>
                <div style="color: #000; text-align: center; font-size: 18px;">
